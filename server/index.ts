import { app } from "../src/libs/shared/presentation/http/app";
import { connectPostgres } from "../src/libs/shared/infrastructure/postgres/PgClient";
...
async function bootstrap() {
    try {
        ...
        // ── SyncWorker ─────────────────────────────────────
        // RunSyncJobUseCase is constructed per-job inside the worker with the job's tenant
        const workerTenantContext: TenantContext = {
            tenantId: "system",
            plan: "pro",
